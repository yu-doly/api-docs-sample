...
#### `npm run split`
Splits the definition into the src folder.

#### `npm test`
Validates the definition.

#### `npm run create:service`
Create folders under src for new service.
...
1. Navigate to the `src/{service-dir}/components/schemas` folder.
...
1. Navigate to the `src/{service-dir}/paths` folder.
...
3. Add the path and a ref to it inside of your `openapi.yaml` file inside of the `src` folder.
